...
if (!function_exists('admin_path')) {
    ...
    {
        return ucfirst(config('central-admin.directory')).($path ? DIRECTORY_SEPARATOR.$path : $path);
    }
}
...
if (!function_exists('admin_url')) {
    ...
    function admin_url($path = '', $parameters = [], $secure = null)
    {
        ...
        $secure = $secure ?: (config('central-admin.https') || config('central-admin.secure'));
...
if (!function_exists('admin_base_path')) {
    ...
    {
        $prefix = '/'.trim(config('central-admin.route.prefix'), '/');
...
if (!function_exists('admin_asset')) {
    ...
    {
        return (config('central-admin.https') || config('central-admin.secure')) ? secure_asset($path) : asset($path);
    }
}
...
if (!function_exists('admin_get_route')) {
    ...
    {
        return config('central-admin.route.prefix').'.'.$name;
    }
}
