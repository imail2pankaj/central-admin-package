<?php
namespace ScenicItSolutions\CentralAdmin\Traits;
...
trait HasAssets
{
    ...
    public static function css($css = null, $minify = true)
    {
        ...
        return view('central-admin::partials.css', compact('css'));
    }
    ...
    public static function baseCss($css = null, $minify = true)
    {
        ...
        // $skin = config('central-admin', 'skin-blue-light');
    ...
    public static function js($js = null, $minify = true)
    {
        ...
        return view('central-admin::partials.js', compact('js'));
    }
    ...
    public static function headerJs($js = null)
    {
        ...
        return view('central-admin::partials.js', ['js' => array_unique(static::$headerJs)]);
    }
    ...
    public static function script($script = '', $deferred = false)
    {
        ...
        return view('central-admin::partials.script', compact('script'));
    }
    ...
    public static function style($style = '')
    {
        ...
        return view('central-admin::partials.style', compact('style'));
    }
    ...
    public static function html($html = '')
    {
        ...
        return view('central-admin::partials.html', ['html' => array_unique(self::$html)]);
    }
    ...
    {
        if (!config('central-admin.minify_assets') || !file_exists(public_path(static::$manifest))) {
            return false;
        }
